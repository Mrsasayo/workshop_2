...
def extract_spotify_data_csv() -> pd.DataFrame:
    ...
    # Usar ruta absoluta basada en la estructura del proyecto proporcionada
    CSV_FILE_PATH = '/home/nicolas/Escritorio/workshops/workshop_2/data/spotify_dataset.csv' # <-- RUTA ABSOLUTA
    logging.info(f"Intentando leer archivo CSV desde: {CSV_FILE_PATH}")

    df_spotify = pd.DataFrame() # Inicializar como DataFrame vacío

    try:
        # Leer el archivo CSV completo.
        # Nota: El notebook 001 lo cargaba en chunks a la DB, aquí solo lo leemos.
        ...
        # Eliminar columna 'Unnamed: 0' si existe (como en el notebook 001)
        ...
        if not df_spotify.empty:
            ...
            # Convertir a string para visualización segura
        ...
        # df_spotify ya está inicializado como vacío
